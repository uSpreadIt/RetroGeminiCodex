...
### Security
- Refresh base image packages during build to include the latest OpenSSL fixes

## [4.14] - 2026-01-24

### Security
- Upgrade the runtime base image to include the latest OpenSSL security fixes
